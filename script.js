...
async function fetchResponse() {
    try {
        const response = await fetch("https://api.render.com/deploy/srv-csmiob5umphs73aj1is0?key=xz85hy_gmGw/start_voice_assistant");  // Adjust to your backend server's address
